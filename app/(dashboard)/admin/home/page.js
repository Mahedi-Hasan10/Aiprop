...
import { DataSource, DataSource2 } from "../../components/data";
 const BarChartPage = dynamic(()=> import("../../components/admin/barChartComponent.js"), {ssr: false,} )
 const PieChartComponent = dynamic(()=> import("../../components/admin/pieChartComponent.js"), {ssr: false,} )
const columns = [
  {
    title: "SL",
    dataIndex: "id",
