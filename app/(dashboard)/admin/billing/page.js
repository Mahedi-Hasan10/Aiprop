    ...
    <div className="bg-white xl:p-[30px] p-[15px] rounded-[5px]">
      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 xl:gap-[30px] gap-3 justify-center">
        ...
        services=" Up to 5 repairmen"
          plans={
            <h2 className="2xl:text-[50px] xl:text-[40px] text-[45px] whitespace-nowrap font-medium flex items-end group-hover:text-white duration-500  lg:leading-[55px] mt-[134px] lg:px-7 px-[20px] md:px-[50px] xl:px-5 2xl:px-[50px]">
              <sup className="text-3xl text-[#030303]/60 duration-500 group-hover:text-[#FFFFFF]/60  font-semibold">
                <LiaDollarSignSolid  className="!font-bold text-[40px] 2xl:text-[60px]" />{" "}
              </sup>{" "}
              149.00{" "}
        ...
        services=" Up to 15 tenants"
          plans={
            <h2 className="2xl:text-[50px] xl:text-[40px] text-[45px] whitespace-nowrap text-white font-medium flex items-end group-hover:text-white duration-500  lg:leading-[55px] mt-[134px] lg:px-7 px-[20px] md:px-[50px] xl:px-5 2xl:px-[50px] ">
        ...
        services=" Basic customer support"
          plans={
            <h2 className="2xl:text-[50px] xl:text-[40px] text-[40px] whitespace-nowrap  font-medium flex items-end group-hover:text-white duration-500  lg:leading-[55px] mt-[134px] lg:px-7 px-[20px] md:px-[50px] xl:px-5 2xl:px-[50px]">
              {" "}
              Custom Price{" "}
            </h2>
          }
